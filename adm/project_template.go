...
import (
	...
	_ "github.com/qtoad/myxgo-admin/adapter/gin"                    // web framework adapter
	_ "github.com/qtoad/myxgo-admin/modules/db/drivers/{{.DriverModule}}" // sql driver
	_ "github.com/qtoad/myxgo-admin/themes/{{.Theme}}"                       // ui theme
...
import (
	...
	_ "github.com/qtoad/myxgo-admin/adapter/chi"                 // web framework adapter
	_ "github.com/qtoad/myxgo-admin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/qtoad/myxgo-admin/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	_ "github.com/qtoad/myxgo-admin/adapter/echo"                 // web framework adapter
	_ "github.com/qtoad/myxgo-admin/modules/db/drivers/{{.DriverModule}}"  // sql driver
	_ "github.com/qtoad/myxgo-admin/themes/{{.Theme}}"                        // ui theme
...
import (
	...
	"github.com/qtoad/myxgo-admin/themes/sword/components/card"
	"github.com/qtoad/myxgo-admin/themes/sword/components/chart_legend"
	"github.com/qtoad/myxgo-admin/themes/sword/components/description"
	"github.com/qtoad/myxgo-admin/themes/sword/components/progress_group"
	"html/template"
)

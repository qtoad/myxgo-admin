...
> make serve</pre>
                    ...
                    <div class="ui attached segment install-success-readme-en"
                        ...
                        <ul>
                            <li>
                                <a href="https://raw.githubusercontent.com/qtoad/myxgo-admin/master/data/admin.sql"
                                   target="_blank">Mysql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/qtoad/myxgo-admin/master/data/admin.mssql"
                                   target="_blank">Mssql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/qtoad/myxgo-admin/master/data/admin.pgsql"
                                   target="_blank">Postgresql</a>
                            </li>
                            <li>
                                <a href="https://raw.githubusercontent.com/qtoad/myxgo-admin/master/data/admin.db"

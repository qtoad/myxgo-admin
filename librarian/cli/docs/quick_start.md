...
你可以选择你拿手的或者业务项目正在用的框架开始，如果上述没有你喜欢的框架，欢迎给我们提[issue](https://github.com/qtoad/xgo-admin/issues/new?assignees=&labels=&template=proposal.md&title=%5BProposal%5D)！
...
import (
	_ "github.com/qtoad/xgo-admin/adapter/gin" // 引入适配器，必须引入，如若不引入，则需要自己定义
	_ "github.com/GoAdminGroup/themes/adminlte" // 引入主题，必须引入，不然报错
	_ "github.com/qtoad/xgo-admin/modules/db/drivers/mysql" // 引入对应数据库引擎
...
其他框架的例子可以参考：[https://github.com/qtoad/xgo-admin/tree/master/examples](https://github.com/qtoad/xgo-admin/tree/master/examples)
...
[https://github.com/qtoad/xgo-admin/blob/master/modules/config/config.go](https://github.com/qtoad/xgo-admin/blob/master/modules/config/config.go)
